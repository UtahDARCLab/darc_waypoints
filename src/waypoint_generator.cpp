...
void fillPositionList(std::vector<geometry_msgs::Vector3>& posList)
{
    ...
    /*top_left.x  = xCen + del;     top_left.y = yCen + 2.0*del;     top_left.z = zCen;
    top_right.x = xCen + del;    top_right.y = yCen - 2.0*del;    top_right.z = zCen;
    bot_left.x  = xCen - del;     bot_left.y = yCen + 2.0*del;     bot_left.z = zCen;
    bot_right.x = xCen - del;    bot_right.y = yCen - 2.0*del;    bot_right.z = zCen;
    ...
    /*top_left.x = xCen + del;     top_left.y = yCen + del;      top_left.z = zCen + del;
    top_right.x = xCen + del;    top_right.y = yCen - del;    top_right.z = zCen + del;
    bot_left.x = xCen - del;     bot_left.y = yCen + del;      bot_left.z = zCen + del;
    bot_right.x = xCen - del;    bot_right.y = yCen - del;    bot_right.z = zCen + del;
